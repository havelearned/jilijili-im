...
public class FriendServiceImpl implements IFriendService {
    ...
    public TableDataInfo<SimpleUser> queryPageList(FriendBo bo, PageQuery pageQuery) {
        ...
        query.eq("imf.user_id", getCurrentUserId())
            ...
            .groupBy(List.of( "imr.unread",
                "imf.create_time"," su.user_id"," su.user_name","su.nick_name", "su.user_type",
                "su.email","su.phonenumber","su.sex","su.avatar","su.password","su.status", "su.create_time"," su.remark"));
