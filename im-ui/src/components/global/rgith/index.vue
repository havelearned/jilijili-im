    ...
    <q-drawer v-model="rgDrawerOpen" side="right" class="global-dark" show-if-above bordered :breakpoint="690"
        ...
        <q-scroll-area style="height: calc(100%);width: 100%" :bar-style="barStyle" :thumb-style="thumbStyle">
            ...
            <div v-else class="absolute-center">
                <div class="card">
                    <q-avatar class=" absolute-top">
                        <q-img :src="currentChatUser.avatar" width="100" height="100">
                            <template #error>
                                <img src="@/assets/def_0.png" width="128" height="128">
                            </template>
                        </q-img>
                    </q-avatar>
                    <div class="card-title">{{ currentChatUser.nickName }}</div>
                    <div class="card-subtitle justify-center items-center">
                        <div>
