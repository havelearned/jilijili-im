            ...
            <q-tab-panels v-model="tabs" class="global-dark" animated swipeable
                ...
                <q-tab-panel name="online">
                    ...
                    <q-list>
                        <q-item v-for="(friend, index) in friendList" :key="friend.userId"
                            ...
                            <q-item-section avatar>
                                <q-avatar>
                                    <div class=" w-5 h-5 absolute-top-left" v-if="friend?.unread">
                                    ...
                                    <img v-else src="@/assets/def_0.png">
                                    <dotOnline class="absolute-bottom-right" :title="'在线'"
                                               v-if="friend.online"></dotOnline>
                                    <dotOnline :color="'grey'" class="absolute-bottom-right" :title="'离线'"
                                               v-else></dotOnline>
                                </q-avatar>
                            </q-item-section>
                            ...
                            <q-item-section>
                                ...
                                <q-item-label class="conversation__summary" caption>
                                    <q-icon name="check"/>
                                    {{ friend?.userName }}:{{ friend?.userType }}
                                </q-item-label>
                            </q-item-section>
                            <q-space/>
                            <q-item-section side>
                ...
                panels = friend.userId
                        ...
                        >
                            ...
                            <q-item-section>
                                ...
                                <q-btn dense class="text-red-400" @click="handelDeleteFriend(friend.userId)">拒绝
                                </q-btn>
                            </q-item-section>
                        </q-item>
                    </q-list>
                ...
                panels = friend.userId
                        ...
                        >
                            ...
                            <q-space/>
                            <q-item-section side>
                                <q-btn dense class="text-red-400" @click="handelDeleteFriend(friend.userId)">解除
                                </q-btn>
                            </q-item-section>
                        </q-item>
                    </q-list>
...
import bottomMe  from "@/components/global/left/index.vue"
